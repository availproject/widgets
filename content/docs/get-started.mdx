---
title: Get Started
description: Install and configure Nexus Elements in your React project. Nexus Widget is the single unified component for all swap, send, and deposit flows.
---
