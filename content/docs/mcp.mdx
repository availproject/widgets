...
The shadcn MCP Server lets Cursor (and other MCP-compatible IDEs) talk directly to your Nexus Elements registry so you can browse, search, and install UI packages with natural language. Detailed platform-agnostic docs live at [ui.shadcn.com/docs/mcp](https://ui.shadcn.com/docs/mcp), but this page focuses on the Nexus Elements setup.

## Build with Nexus One

<span className="block mt-6" />

**Nexus One** is the single unified component for all swap, send, and deposit flows. Install it with one command:
...
All legacy standalone elements (FastBridge, FastTransfer, SwapWidget, Deposit, BridgeDeposit, UnifiedBalance, ViewHistory) have been deprecated and removed in favor of Nexus One.
